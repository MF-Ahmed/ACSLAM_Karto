...
ros1_path_setup_ws = "~/data/matteo_thesis/karto_slam/thesis_ws/devel"
...
ros1_mapsaver = "rosrun map_server map_saver -f /home/usr/data/matteo_thesis/karto_slam/thesis_ws/results/simulation/hospital/$map_$(date +'%Y%m%d_%H%M%S')"
