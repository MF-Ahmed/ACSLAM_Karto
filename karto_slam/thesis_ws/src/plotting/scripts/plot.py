...
def save_simulation_data(simulation_id):
    ...
    filename = os.path.join(data_directory, f'data-{simulation_id}-{synch_asynch}.npy')
...
class PlotterNode(object):
    def __init__(self, simulation_id):
        ...
        rospy.loginfo(f"plotting node started with ID:  {simulation_id}")
