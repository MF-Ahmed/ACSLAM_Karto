...
class ChooseGoalGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.int8(obj.rows, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.rows = _arrayDeserializer.int8(buffer, bufferOffset, null)
    return data;
  }
