...
class ChooseGoalGoal(genpy.Message):
  _md5sum = "ccc4eb8941602a0039260071e46f98e1"
...
uint32 rows
float32[] data"""
  __slots__ = ['client_id','matrix','rows']
  _slot_types = ['string','graph_d_exploration/InfoMatrix','int8[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sb'%length
      buff.write(struct.Struct(pattern).pack(*self.rows))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.rows = s.unpack(str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.rows = numpy.frombuffer(str[start:end], dtype=numpy.int8, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
