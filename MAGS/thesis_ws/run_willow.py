...
ros1_simulation_cmd = "roslaunch graph_d_exploration file_wg.launch"
...
config_path = os.path.join(script_dir, "WG_config.yaml")
...
if __name__ == "__main__":
    for i in range(20):
        ...
        result_folder = f"/home/usr/data/catkin_ws/src/thesis_ws/results/simulation/WillowGarage/run_{timestamp}_{num_robots}_robots"
