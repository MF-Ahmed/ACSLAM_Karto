...
# File name
file_name = "/graph_2.g2o"

# Construct the absolute path to the file
file_path = os.path.join(current_directory, file_name)

base_file_path = current_directory
#base_file_path = '/home/farhan/data/catkin_ws/acslam_karto_ws/src/MAGS/results/plot_g2o'
...
if __name__ == '__main__':
    try:
        ...
        G_o.plot_graph_rot('Trajectory', 'red', True, rotate_90_cw=True)
