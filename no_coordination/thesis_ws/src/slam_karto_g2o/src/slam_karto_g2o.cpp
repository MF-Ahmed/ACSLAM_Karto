        ...
        marker_count_(0)
{
  ...
  if(!private_nh_.getParam("namespace", namespace_))
    namespace_ = "";
  ...
  if(!private_nh_.getParam("resolution", resolution_))
  {
   ...
   ROS_INFO("# open Karto got namespace  as : %s #", namespace_.c_str());
...
SlamKarto::publishGraphVisualization()
{
  ...
  else if (namespace_.c_str() == "robot_1")
  {
  ...
  else if (namespace_.c_str() == "robot_2")
  {
  ...
  else if (namespace_.c_str() == "robot_3")
  {
