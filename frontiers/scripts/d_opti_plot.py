...
GRAPH_PATH_ = "/home/usr/data/catkin_ws/src/aslam_turtlebot/maps/posegraph_map.g2o"
opt_total2=0
...
def plot(data):
    ...
    plt.plot(times, values, '.-', color='orange', linewidth=2, markersize=6,
             markerfacecolor='white', markeredgewidth=1.2, markeredgecolor='orange')
    plt.ylim(1000,5000)
    ...
    file_name = f"/home/usr/data/catkin_ws/src/aslam_turtlebot/results/d_opti_graph.png"
...
if __name__ == '__main__':
    ...
    rospy.init_node('goals_subscriber')
    rospy.Subscriber('/explore/goals_topic', Point, goalcallback)
    rospy.Subscriber('/explore/time_topic', Time, goaltimecallback)
    rospy.loginfo("Initialized the goals_topic subscriber")
    rospy.spin()     
